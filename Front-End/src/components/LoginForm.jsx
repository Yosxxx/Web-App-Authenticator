    ...
    return (
        <div className="w-[60vw] md:w-[50vw] lg:w-[35vw] h-[78vh] md:h-[78vh] lg:h-[78vh] bg-[#2E313C]/80 p-[6vw] md:p-[4vw] lg:p-[2vw] lg:pr-[4vw] lg:pl-[4vw] rounded-3xl md:rounded-3xl lg:rounded-3xl flex flex-col justify-center items-center gap-4 md:gap-[2vh] max-w-lg z-20">
            <div className="flex flex-col justify-center items-center">
                <h1 className="text-3xl md:text-3xl lg:text-4xl font-bold tracking-[15px] bg-gradient-to-r from-[#BBC1CF] to-[#95A8C9] text-transparent bg-clip-text">F4</h1>
                <h1 className="text-3xl md:text-3xl lg:text-4xl font-bold tracking-[15px] bg-gradient-to-r from-[#BBC1CF] to-[#95A8C9] text-transparent bg-clip-text">C3</h1>
                <p className="bg-gradient-to-r from-[#BBC1CF] to-[#95A8C9] text-transparent bg-clip-text mt-2 md:mt-[1vh] text-sm md:text-base">Face Recognition AI</p>
            </div>
            ...
            <div className="w-full">
                ...
                <div className="flex flex-col items-center mt-4">
                    ...
                    <button className="mt-2 p-3">
                        <Icon icon="mdi:face-recognition" className="w-16 h-16 md:w-[8vh] lg:w-[10vh] md:h-[8vh] lg:h-[10vh] text-[#BBC1CF] cursor-pointer" />
                    </button>
                </div>
            </div>
